...
a = Analysis(
    ...
    datas=[('config/*', 'config'), ('data/db/medical_database.db', 'data/db'), ('db_master_style.qss', '.'), ('db_master.qrc', '.'), ('data_collection2.mp3', '.'), ('endTip.mp3', '.'), ('Pictures/*', 'Pictures'), ('res/*', 'res'), ('EEG_Data/User_Data/*', 'EEG_Data/User_Data'), ('csv_file/*', 'csv_file')],
